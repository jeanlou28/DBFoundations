...
-- 2024-08-07, Jean Mondesir,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_JeanMondesir')
	 Begin 
	  Alter Database [Assignment06DB_JeanMondesir] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_JeanMondesir;
	 End
	Create Database Assignment06DB_JeanMondesir;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_JeanMondesir;
...
As
Select Top 1000000 i.InventoryDate, c.CategoryName, p.ProductName, i.[Count],
       e.EmployeeFirstName + ' ' + e.EmployeeLastName As EmployeeName
From vInventories i
Inner Join vProducts p On i.ProductID = p.ProductID
...
As
Select Top 1000000 m.EmployeeFirstName + ' ' + m.EmployeeLastName As ManagerName,
       e.EmployeeFirstName + ' ' + e.EmployeeLastName As EmployeeName
From vEmployees e
